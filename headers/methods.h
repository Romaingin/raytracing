...
color_t tracer (Scene& scene, glm::vec3 ray, glm::vec3 origin, size_t depth);
...
color_t reflectionMapping (Scene& scene, int faceId, size_t elementId, glm::vec3 origin, glm::vec3 incidentRay, glm::vec3 normal, size_t depth);
